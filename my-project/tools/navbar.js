      ...
      <div className="flex-1 flex justify-evenly">
        <div className="flex-1 flex h-5 w-screen">
          ...
          <div className="fixed top-4 right-20">
            <button className="bg-yellow-400 font-bold border-2 border-black border-spacing-3 px-4 py-1 border-solid rounded hover:bg-yellow-500">Download Pin</button>
          </div>
        </div>
      </div>
    </div>
